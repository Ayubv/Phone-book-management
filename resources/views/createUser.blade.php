    ...
    <div class="col-md-6  offset-3">
            <div class="card shadow-lg border-0 rounded-lg mt-5">
                <div class="card-header">
                    <h3 class="text-center font-weight-light my-4">Users Forms</h3>
                </div>
                <div class="card-body">
                   
                        {!! Form::open(['url'=>'/storeUser','method'=>'POST']) !!}
                ...
                <div class="card-footer text-center py-3">
                    <div class="lg"><a class="btn btn-danger d-grid" href="{{url('showusers')}}">Back</a></div>
                </div>
            </div>
        </div>
